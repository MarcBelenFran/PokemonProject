...
public class tablaMovimientos extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			resultado = BuscadorMovimientos.mostrarTabla(request.getParameter("idUsuario"),BuscadorPokemon.idImagen(request.getParameter("imagenPokemon")),request.getParameter("tipoTabla"));
		} catch (Exception e) {
